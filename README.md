...
MVP slice: the full game engine (lesson → multi-page timed drill → mastery scoring → belt map) is built and working end-to-end for **White Belt (Addition)**, all 4 stripes:
